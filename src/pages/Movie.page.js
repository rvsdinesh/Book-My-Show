...
const launchRazorPay = () =>{
   const options = {
      key:"rzp_test_dXv5OgNzPIbShI",
      amount: 500*100,
      currency: "INR",
      name: "Full stack web fee",
      description: "Payment of FUll Stack web",
...
const  Movie = () => {
  return (
   ...
   <button onClick={launchRazorPay} className="mt-4 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
   Book Tickets
   </button>
